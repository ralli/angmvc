...
import angmvc.web.models.ValidationErrors;
...
public class ApiController {
  ...
  public
  @ResponseBody
  ValidationErrors processValidationErrors(MethodArgumentNotValidException ex) {
  ...
  private ValidationErrors processFieldErrors(List<FieldError> fieldErrors) {
    ...
    for (FieldError fieldError : fieldErrors) {
      ...
      dto.addFieldError(fieldError.getField(), fieldError.getCodes()[0], localizedErrorMessage);
    }
